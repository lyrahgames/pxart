...
\label{sec:pseudorandom_number_generators}
  ...
  % \label{ssub:xorshift_and_variants}
    ...
    \label{def:xoroshiro}
      ...
      Then the Xoroshiro128+ $\mathrm{Xoroshiro128+}(a,b,c)\define (S,T,U,G)$ is defined as a PRNG in the following way.
      \[
    ...
    \begin{figure}
      ...
      \caption[Xoroshiro128+ Transition and Generation]{
        ...
        The notation is taken from \ref{def:xoroshiro}.
      }
  ...
  % \label{ssub:middle_square_weyl_sequence_rng}
    ...
    \begin{figure}
      ...
      \caption[Middle Square Weyl Sequence RNG Transition and Generation]{
        ...
        The notation is taken from \ref{def:msws}.
      }
