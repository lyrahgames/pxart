...
\label{sec:background}
  ...
  \label{sub:pseudorandom_number_generators}
    ...
    Using a TRNG in a computer system is like consulting an oracle.
    ...
    Hence, the set of output symbols and the generator in the definition of PRNGs is as important as the set of states and the transition function.
