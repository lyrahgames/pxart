...
\label{sub:preliminaries}
  ...
  \label{sub:the_c_programming_language}
    ...
    In this thesis, we will rely on the random utilities the STL exhibits in its header \code{random}.
    ...
    \begin{description}
      ...
      \item[Type Traits]
        ...
        In the STL a typical examples is given by \code{std::is\_same\_v} which is evaluating if two types are the same.
    \end{description}
