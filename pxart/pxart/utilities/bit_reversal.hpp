...
constexpr auto consecutive_mask = static_cast<Integer>(
    0b0011001100110011001100110011001100110011001100110011001100110011UL);
template <typename Integer>
constexpr auto nibble_mask = static_cast<Integer>(
    0b0000111100001111000011110000111100001111000011110000111100001111UL);
template <typename Integer>
constexpr auto byte_mask = static_cast<Integer>(
    0b0000000011111111000000001111111100000000111111110000000011111111UL);
template <typename Integer>
constexpr auto short_mask = static_cast<Integer>(
    0b0000000000000000111111111111111100000000000000001111111111111111UL);
